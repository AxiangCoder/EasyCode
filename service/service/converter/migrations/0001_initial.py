    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('design_tokens', models.ForeignKey(blank=True, help_text='使用的设计令牌', null=True, on_delete=django.db.models.deletion.SET_NULL, to='converter.designtokens')),
            ],
            options={
                'verbose_name': '转换任务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('html_output', models.TextField(blank=True, help_text='HTML预览输出', null=True)),
                ('token_report', models.JSONField(blank=True, default=dict, help_text='令牌使用报告', null=True)),
                ('llm_usage', models.JSONField(blank=True, help_text='LLM token 用量汇总', null=True)),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('task', models.OneToOneField(help_text='关联的转换任务', on_delete=django.db.models.deletion.CASCADE, related_name='result', to='converter.conversiontask')),
            ],
            options={
                'verbose_name': '转换结果',
