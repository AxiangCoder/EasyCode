...
以下所有任务均已移出 Sprint 1，将在核心流程打通后，根据优先级进入后续的迭代计划。原“Bug 修复”“进度条优化”“DSL 文件归档输出”“前端压缩包统一命名”已上调至 Sprint 2。
...
*   **压缩包解压与验收**: 解压 `code.zip` 前先确认任务编号，解压后核对页面与 `dsl.json` 节点定义的一致性；如有不一致，记录并修复。
